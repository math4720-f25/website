...
```{r}
#| out-width: 100%
knitr::include_graphics("./images/11-infer-two-means/two_indept_sample_overview_new.png")
```
:::
...
- Step 6:  <span style="color:blue"> **There is insufficient evidence to support the claim that the the oversized racket delivers less stress to the elbow**. </span>
...
- We are 95% confident that the difference in the mean weight is between -2.67 and -1.53.
