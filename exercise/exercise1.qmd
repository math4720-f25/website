...
\item The average GPA of students in 2001 at a private university was 3.37. A survey on a sample of 203 students from this university yielded an average GPA of 3.59 a decade later.
\end{enumerate}
...
\begin{enumerate}
\item If 1 adult female is randomly selected, find the probability that her pulse rate is less than 80 beats per minute.
\item If 16 adult female are randomly selected, find the probability that their mean pulse rate is less than 80 beats per minute.
\end{enumerate}
