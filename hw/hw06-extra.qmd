...
(@) Download the the R script [pumpkin.R](../code/pumpkin.R), and run the code to generate your statistical pumpkin! Include the resulting image in your Homework 6.
