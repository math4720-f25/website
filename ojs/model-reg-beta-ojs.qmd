...
```{ojs}
viewof n_1 = Inputs.range([10, 1000], {value: 10, step: 1, label: tex`\text{sample size, }n`});
...
&#128309; estimated b<sub>0</sub> for the current data.
  ...
  marks: [
    Plot.rectY(data_estimates_1[1].filter((d,i) => i<= (sampleno_1-1)), Plot.binX({y: d => (d.length/sampleno_1)/(20/sampleno_1)}, {x: "intercept", thresholds: d3.range(b0samp_range[0], b0samp_range[1], 20/sampleno_1), fill: "steelblue", opacity: 0.5}) ),
    Plot.ruleY([0]),
...
&#128309; estimated b<sub>1</sub> for the current data.
  ...
  marks: [
    Plot.rectY(data_estimates_1[1].filter((d,i) => i<= (sampleno_1-1)), Plot.binX({y: d => (d.length/sampleno_1)/(20/sampleno_1)}, {x: "lutning", thresholds: d3.range(b1samp_range[0], b1samp_range[1], 20/sampleno_1), fill: "steelblue", opacity: 0.5}) ),
    Plot.ruleY([0]),
