...
Your project has three parts: the **data analysis report**, **personal reflection**, and **AI chat history**. Please use the initial prompt (@sec-prompt) to start your conversation with AI.
...
I am working on a multiple linear regression project using a small health related data set with three variables: sleep, caffeine, and stress. I want you to act as a thinking partner. Please do not give me the full answers. Instead, guide my thinking with explanations of why certain steps make sense and what ideas I should consider when making decisions.

Please ask me clarifying questions when needed. Explain the reasoning behind each concept slowly and clearly. Help me understand the process rather than giving me the final interpretations or the exact text for my report.

You may give examples of how to think about plots, interpretations, and model evaluation, but they should be general examples. They should not be statements that directly answer my project with specific values from my data set. Let me do the calculations, write the interpretations, and make the final decisions.

Please help me develop my understanding of multiple linear regression by asking reflective questions such as:
...
Your role is to support my reasoning and to help me understand how to build and interpret the model step by step, but not to create my report content for me.
