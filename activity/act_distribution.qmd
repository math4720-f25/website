---
title: "In-class Activity: Match the Scenario to the Distribution"
---

## **Objective**

You will practice identifying which type of probability distribution (**binomial**, **Poisson**, or **normal**) fits a given real-world context, and explain why.
...
(2) Scan the QR code, or go to <https://forms.office.com/r/eiiVmnu3nq> to fill out your names.
...
(4) The group with the most correct answers will get a hex sticker, and share their reasoning!

```{r}
#| echo: false
#| column: margin
knitr::include_graphics("../images/QRCode_distribution.png")
```
...
(@) The number of emails arriving in a professor’s inbox between 2 and 3 pm. 

(@) The distribution of households income in Wisconsin, USA
...
(@) The distribution of IQ scores of adults in Milwaukee.
